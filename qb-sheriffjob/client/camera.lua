...
RegisterNetEvent('sheriff:client:ActiveCamera')
AddEventHandler('sheriff:client:ActiveCamera', function(cameraId)
...
RegisterNetEvent('sheriff:client:DisableAllCameras')
AddEventHandler('sheriff:client:DisableAllCameras', function()
    for k, v in pairs(Config.SecurityCameras.cameras) do 
        Config.SecurityCameras.cameras[k].isOnline = false
    end
end)

RegisterNetEvent('sheriff:client:EnableAllCameras')
AddEventHandler('sheriff:client:EnableAllCameras', function()
    for k, v in pairs(Config.SecurityCameras.cameras) do 
        Config.SecurityCameras.cameras[k].isOnline = true
    end
end)

RegisterNetEvent('sheriff:client:SetCamera')
AddEventHandler('sheriff:client:SetCamera', function(key, isOnline)
