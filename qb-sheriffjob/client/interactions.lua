...
RegisterNetEvent('sheriff:client:SetOutVehicle')
AddEventHandler('sheriff:client:SetOutVehicle', function()
...
RegisterNetEvent('sheriff:client:PutInVehicle')
AddEventHandler('sheriff:client:PutInVehicle', function()
...
RegisterNetEvent('sheriff:client:SearchPlayer')
AddEventHandler('sheriff:client:SearchPlayer', function()
...
RegisterNetEvent('sheriff:client:SeizeCash')
AddEventHandler('sheriff:client:SeizeCash', function()
    local player, distance = GetClosestPlayer()
    if player ~= -1 and distance < 2.5 then
        local playerId = GetPlayerServerId(player)
...
RegisterNetEvent('sheriff:client:SeizeDriverLicense')
AddEventHandler('sheriff:client:SeizeDriverLicense', function()
    local player, distance = GetClosestPlayer()
    if player ~= -1 and distance < 2.5 then
        local playerId = GetPlayerServerId(player)
...
RegisterNetEvent('sheriff:client:RobPlayer')
AddEventHandler('sheriff:client:RobPlayer', function()
    local player, distance = GetClosestPlayer()
    if player ~= -1 and distance < 2.5 then
...
RegisterNetEvent('sheriff:client:JailCommand')
AddEventHandler('sheriff:client:JailCommand', function(playerId, time)
    TriggerServerEvent("sheriff:server:JailPlayer", playerId, tonumber(time))
end)

RegisterNetEvent('sheriff:client:BillCommand')
AddEventHandler('sheriff:client:BillCommand', function(playerId, price)
    TriggerServerEvent("sheriff:server:BillPlayer", playerId, tonumber(price))
end)

RegisterNetEvent('sheriff:client:JailPlayer')
AddEventHandler('sheriff:client:JailPlayer', function()
    local player, distance = GetClosestPlayer()
    if player ~= -1 and distance < 2.5 then
        local playerId = GetPlayerServerId(player)
...
RegisterNetEvent('sheriff:client:BillPlayer')
AddEventHandler('sheriff:client:BillPlayer', function()
    local player, distance = GetClosestPlayer()
    if player ~= -1 and distance < 2.5 then
        local playerId = GetPlayerServerId(player)
        DisplayOnscreenKeyboard(1, "", "", "", "", "", "", 20)
...
RegisterNetEvent('sheriff:client:PutPlayerInVehicle')
AddEventHandler('sheriff:client:PutPlayerInVehicle', function()
    local player, distance = GetClosestPlayer()
    if player ~= -1 and distance < 2.5 then
        local playerId = GetPlayerServerId(player)
        if not isHandcuffed and not isEscorted then
...
RegisterNetEvent('sheriff:client:SetPlayerOutVehicle')
AddEventHandler('sheriff:client:SetPlayerOutVehicle', function()
    local player, distance = GetClosestPlayer()
    if player ~= -1 and distance < 2.5 then
        local playerId = GetPlayerServerId(player)
        if not isHandcuffed and not isEscorted then
...
RegisterNetEvent('sheriff:client:EscortPlayer')
AddEventHandler('sheriff:client:EscortPlayer', function()
    local player, distance = GetClosestPlayer()
    if player ~= -1 and distance < 2.5 then
        local playerId = GetPlayerServerId(player)
        if not isHandcuffed and not isEscorted then
...
RegisterNetEvent('sheriff:client:KidnapPlayer')
AddEventHandler('sheriff:client:KidnapPlayer', function()
    local player, distance = GetClosestPlayer()
    if player ~= -1 and distance < 2.5 then
        local playerId = GetPlayerServerId(player)
...
RegisterNetEvent('sheriff:client:CuffPlayerSoft')
AddEventHandler('sheriff:client:CuffPlayerSoft', function()
...
RegisterNetEvent('sheriff:client:CuffPlayer')
AddEventHandler('sheriff:client:CuffPlayer', function()
    if not IsPedRagdoll(PlayerPedId()) then
        local player, distance = GetClosestPlayer()
        if player ~= -1 and distance < 1.5 then
...
RegisterNetEvent('sheriff:client:GetEscorted')
AddEventHandler('sheriff:client:GetEscorted', function(playerId)
...
RegisterNetEvent('sheriff:client:DeEscort')
AddEventHandler('sheriff:client:DeEscort', function()
    isEscorted = false
    TriggerEvent('hospital:client:isEscorted', isEscorted)
    DetachEntity(PlayerPedId(), true, false)
end)

RegisterNetEvent('sheriff:client:GetKidnappedTarget')
AddEventHandler('sheriff:client:GetKidnappedTarget', function(playerId)
    QBCore.Functions.GetPlayerData(function(PlayerData)
...
RegisterNetEvent('sheriff:client:GetKidnappedDragger')
AddEventHandler('sheriff:client:GetKidnappedDragger', function(playerId)
    QBCore.Functions.GetPlayerData(function(PlayerData)
...
RegisterNetEvent('sheriff:client:GetCuffed')
AddEventHandler('sheriff:client:GetCuffed', function(playerId, isSoftcuff)
