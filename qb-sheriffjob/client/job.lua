                    ...
                    if #(pos - vector3(v.x, v.y, v.z)) < 5 then
                        if #(pos - vector3(v.x, v.y, v.z)) < 1.5 then
                            ...
                            if IsControlJustReleased(0, 38) then
                                ...
                                TriggerEvent('qb-sheriffalerts:ToggleDuty', onDuty)
                            end
                        ...
                        if onDuty then
                            ...
                            if #(pos - vector3(v.x, v.y, v.z)) < 1.5 then
                                if IsPedInAnyVehicle(PlayerPedId(), false) then
                                    ...
                                    DrawText3D(v.x, v.y, v.z, "~g~E~w~ - sheriff Impound")
                                end
                                if IsControlJustReleased(0, 38) then
                                    if IsPedInAnyVehicle(PlayerPedId(), false) then
                                        QBCore.Functions.DeleteVehicle(GetVehiclePedIsIn(PlayerPedId()))
...
RegisterNetEvent('sheriff:client:showFingerprint')
AddEventHandler('sheriff:client:showFingerprint', function(playerId)
    openFingerprintUI()
    FingerPrintSessionId = playerId
end)

RegisterNetEvent('sheriff:client:showFingerprintId')
AddEventHandler('sheriff:client:showFingerprintId', function(fid)
    SendNUIMessage({
...
RegisterNetEvent('sheriff:client:SendEmergencyMessage')
AddEventHandler('sheriff:client:SendEmergencyMessage', function(message)
...
RegisterNetEvent('sheriff:client:EmergencySound')
AddEventHandler('sheriff:client:EmergencySound', function()
    PlaySound(-1, "Event_Start_Text", "GTAO_FM_Events_Soundset", 0, 0, 1)
end)

RegisterNetEvent('sheriff:client:CallAnim')
AddEventHandler('sheriff:client:CallAnim', function()
...
RegisterNetEvent('sheriff:client:ImpoundVehicle')
AddEventHandler('sheriff:client:ImpoundVehicle', function(fullImpound, price)
...
RegisterNetEvent('sheriff:client:CheckStatus')
AddEventHandler('sheriff:client:CheckStatus', function()
...
function MenuImpound()
    ...
    MenuTitle = "Impounded"
    ClearMenu()
    Menu.addButton("sheriff Impound", "ImpoundVehicleList", nil)
...
function TakeOutImpound(vehicle)
    ...
    QBCore.Functions.SpawnVehicle(vehicle.vehicle, function(veh)
        QBCore.Functions.TriggerCallback('qb-garage:server:GetVehicleProperties', function(properties)
            ...
            TriggerServerEvent('sheriff:server:TakeOutImpound',vehicle.plate)
            closeMenuFull()
            TaskWarpPedIntoVehicle(PlayerPedId(), veh, -1)
            TriggerEvent("vehiclekeys:client:SetOwner", GetVehicleNumberPlateText(veh))
            SetVehicleEngineOn(veh, true, true)
